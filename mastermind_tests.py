import unittest
from mastermind.mastermind_game import MastermindGame
...
class MastermindTest(unittest.TestCase):    
    ...
    def testLostGame(self):
        mastermind = MastermindGame(15) 
        self.assertIsInstance(mastermind.guess([], []), Result)
        self.assertIsInstance(mastermind.guess([], []), LostGame) 
